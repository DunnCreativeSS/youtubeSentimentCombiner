...
def get_video_comment(url):
    ...
    parser.add_argument("--key", help="Required API key", default='IzaSyA2LE4GGF55t-96NwB5nrF06_AWSumsgYg')
...
def openURL(url, parms):
    ...
    return matches
try:
    parms = {'q': 'bitcoin exchange', 'part':'snippet', 'maxResults':10, 'regionCode': 'US', 'key': 'IzaSyA2LE4GGF55t-96NwB5nrF06_AWSumsgYg'}
